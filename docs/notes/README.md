# Mafia Night - Knowledge Base

Welcome to the atomic notes knowledge base for Mafia Night! 🎭
...
If viewing in Obsidian:
- Use **Graph View** to visualize connections
- Use **Quick Switcher** (Cmd/Ctrl+O) to jump between notes
- Use **Backlinks** to see what references current note
- Use **Tags** to filter notes by topic
